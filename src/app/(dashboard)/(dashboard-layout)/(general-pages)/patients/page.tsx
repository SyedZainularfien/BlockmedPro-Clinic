...
const Patients: NextPage = () => {
  ...
  const handleViewPrescription = (id: string) => {
    router.push(`/patients/prescription/${id}`);
  };

  const handleViewReciept = (id: string) => {
    router.push(`/patients/patient-invoice/${id}`);
  };
  ...
  const dropdownOptions = (id: string): IDropdownItemType[] => [
    {
      ...
      onClick: () => handleViewPrescription(id),
    },
    {
      id: '2',
      variant: 'primary',
      ...
      <div className="flex flex-col gap-5">
        ...
        <Container hasBorders>
          ...
          <DataTable
            ...
            ColumnsData={content?.columns?.patientsColumnData}
            TableBodyRow={({
              _id,
              idx,
              name,
